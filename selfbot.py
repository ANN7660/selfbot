# self.py - Presence 24/7 avec bouton
...
@app.route('/')
def home():
    return "Discord Presence 24/7 Active ✨"
...
class DiscordSelfbot:
        ...
        payload = {
            ...
            "d": {
                ...
                "activities": [{
                    ...
                    "buttons": [
                        {"label": "🔥 Profil", "url": "https://guns.lol/17h40"}
                    ]
                }],
                "since": None,
                "afk": False
    ...
    async def listen(self):
        async for msg in self.ws:
            ...
            if data["op"] == 0 and data.get("t") == "READY":
                await self.update_presence()

async def main():
    token = os.getenv("DISCORD_TOKEN")
    if not token:
        print("❌ ERREUR : Variable DISCORD_TOKEN absente !")
        return
